...
export class QueryBuilder<T = any> {
  ...
  async insert(data: Partial<T>): Promise<number | undefined> {
    ...
    console.log('🔧 [QueryBuilder] Dados:', data)
    ...
    console.log('🔧 [QueryBuilder] SQL gerado:', sql)
    console.log('🔧 [QueryBuilder] Valores:', values)
    console.log('🔧 [QueryBuilder] Chamando sqliteDatabase.query()...')
    
    const result = await sqliteDatabase.query(sql, values)
    
    console.log('✅ [QueryBuilder] Query executado!')
    console.log('✅ [QueryBuilder] insertId:', result.insertId)
    console.log('✅ [QueryBuilder] rowsAffected:', result.rowsAffected)
